...
const MediaPlayer: React.FC<MediaPlayerProps> = ({ videoUri, canDownload, contentId, title, thumbnailUrl }) => {
  ...
  const handleDownloadVideo = async () => {
    ...
    // Call the downloadVideo function with valid contentId
    downloadVideo(contentId, videoUri, title || 'Unknown Title', thumbnailUrl || '', 
        ...
        {clicked && (
          <View style={styles.overlay}>
            <View style={styles.controlsRow}>
              ...
              {canDownload && (
                <TouchableOpacity onPress={handleDownloadVideo} style={styles.downloadButton}>
